...
public class Assignment5 {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student(1093060502, "Amy", "MIS", 107, tutor1.getName(),95);
		Student student2 = new Student(1093060503, "Joy", "Acc", 108, tutor1.getName(),88);
		DoubleMajor student3 = new DoubleMajor(1093060504, "David", "MIS", 106, tutor2.getName(), 89, "CS");
